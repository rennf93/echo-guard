"""
Version bump helper script for echo-guard.

echo-guard is a Go module: there is no version file to update, the git
...
def main() -> int:
    ...
    print(
        "  Note: echo-guard has no version file; the git tag is the version.\n"
